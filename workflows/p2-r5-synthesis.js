...
const CHAPTERS = [
  ...
  { file: '08-the-machine-market.md', spec: 'Era 7, The Machine Market (2008-2026). Sources: era-7.json + mechanism.json (finding f10). Programmatic; mobile; the auction death sequence — header bidding (~2014-15), then TWO changes in 2019 that ran in OPPOSITE directions on opposite sides of the business: open-web DISPLAY moved to a unified FIRST-price auction (Google Ad Manager, 2019-09-05, transparency rationale, self-reported neutral-to-positive revenue effect), while SEARCH got rGSP (explicit revenue rationale, disclosed +5.74% persistent gain). SEARCH NEVER WENT FIRST-PRICE — do not state or imply otherwise; this is a verified correction to the popular account. Then the pricing knobs (squashing, format pricing) from the DOJ disclosures. Privacy shocks; concentration and the triopoly+; the antitrust endgame; the AI beats through the 2026-06-30 freeze; unit economics including the LLM inference comparison.' },
